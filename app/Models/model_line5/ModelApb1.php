...
class ModelApb1 extends Model
{
    ...
    protected $allowedFields    = ['L5_APB1_TEMP_LEFT_SETTING', 'L5_APB1_TEMP_LEFT_ACTUAL', 'L5_APB1_TEMP_RIGHT_SETTING', 'L5_APB1_TEMP_RIGHT_ACTUAL', 'L5_APB1_FIRST_DIPPING_TIME', 'L5_APB1_WELD_HEAD_DOWN_TIME', 'L5_APB1_COOLING_TIME', 'L5_APB1_FLAME_WAITING_TIME', 'waktu'];
