        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data.data || data.data.length === 0) {
                    ...
                    updateOrCreateChart(
                        'container', chart, 'Cell 1', [], [], 'L6_ALT1_ACTUAL_PRESSURE_CELL1',
                        (newChart) => {
                            chart = newChart;
                        },
                        [], []
        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data.data || data.data.length === 0) {
                    ...
                    console.log('No data received or data is empty');
                    updateOrCreateChart(
                        'container2', chart3, 'Cell 3', [], [], 'L6_ALT1_ACTUAL_PRESSURE_CELL3',
                        (newChart) => {
                            chart3 = newChart;
                        },
                        [], []
        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data.data || data.data.length === 0) {
                    ...
                    console.log('No data received or data is empty');
                    updateOrCreateChart(
                        'container3', chart5, 'Cell 5', [], [], 'L6_ALT1_ACTUAL_PRESSURE_CELL5',
                        (newChart) => {
                            chart5 = newChart;
                        },
                        [], []
        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data.data || data.data.length === 0) {
                    ...
                    console.log('No data received or data is empty');
                    updateOrCreateChart(
                        'container4', chartresult1, 'Result Cell 1', [], [], 'L6_ALT1_RESULT_CELL1',
                        (newChart) => {
                            chartresult1 = newChart;
                        },
                        [], []
        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data.data || data.data.length === 0) {
                    ...
                    console.log('No data received or data is empty');
                    updateOrCreateChart(
                        'container5', chartresult3, 'Result Cell 3', [], [], 'L6_ALT1_RESULT_CELL3',
                        (newChart) => {
                            chartresult3 = newChart;
                        },
                        [], []
        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data.data || data.data.length === 0) {
                    ...
                    console.log('No data received or data is empty');
                    updateOrCreateChart(
                        'container6', chartresult5, 'Result Cell 5', [], [], 'L6_ALT1_RESULT_CELL5',
                        (newChart) => {
                            chartresult5 = newChart;
                        },
                        [], []
